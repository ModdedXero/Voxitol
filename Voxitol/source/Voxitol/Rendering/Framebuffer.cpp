...
namespace Voxitol::Rendering
{
	...
	namespace Utils
	{
		...
		static GLenum TextureFormat(FramebufferTextureFormat format)
		{
			switch (format)
			{
			case Voxitol::Rendering::FramebufferTextureFormat::RGBA8:
				return GL_RGBA8;
				break;
			case Voxitol::Rendering::FramebufferTextureFormat::RED_INTEGER:
				return GL_RED_INTEGER;
				break;
			case Voxitol::Rendering::FramebufferTextureFormat::DEPTH24STENCIL8:
	...
	void Framebuffer::Invalidate()
	{
		...
		{
			// Log Error Attachment count exceeded
			if (m_ColorAttachments.size() <= 4) return;
